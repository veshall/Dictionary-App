    ...
    <div className="flex flex-col gap-5 lg:gap-2">
      <section>
        <div className="flex justify-between items-center">
          <h2 className=" text-4xl font-medium lg:text-5xl lg:mb-2">{word}</h2>
      ...
      <section>
        <h3 className="text-2xl font-semibold mb-2 italic">noun</h3>
        <h4 className="text-xl font-light text-gray-400 ">Meaning</h4>

        <ul className=" mb-4 lg:mb-0 p-2 list-disc list-inside space-y-3 leading-5 lg:text-base lg:leading-6">
        ...
        <div className="inline-flex items-center gap-10">
          <h4 className="text-xl text-gray-400">Synonyms</h4>
      ...
      <section>
        <h3 className="text-2xl font-semibold mb-2 italic">verb</h3>
        <h4 className="text-xl font-light text-gray-400 ">Meaning</h4>
        <ul className=" mb-4 lg:mb-0 p-2 list-disc list-inside space-y-3 leading-5 lg:text-base lg:leading-6">
